...
public class ItemDetailFragment extends Fragment {
     ...
     */
    private PersonContent.Person mItem;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Show the dummy lastName as text in a TextView.
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.item_detail)).setText(mItem.dateOfBirth);
        }
